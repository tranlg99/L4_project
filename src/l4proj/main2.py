...
CHECKPOINT = CHECKPOINT_FOLDER+"model_4_dropout2_checkpoint_2023-03-03_0539.pth"
...
my_model = initialise_model(device, to_learn=['all'], drop_out=2)
params_to_update = my_model.parameters()

# LOAD MODEL WEIGHTS FROM CHECKPOINT
if CHECKPOINT:
    model_weights, best_valid_weights, train_past_loss, validation_past_loss, optimizer_state, train_time = load_checkpoint(CHECKPOINT, device=device)
    if CONTINUE_TRAIN:
